...
---
<b>Overview</b>
This is my current graduate research project at Arizona State University, conducted under the supervision of Prof. Leslie K. Hwang.
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/FNO-1.png"
...
Geometry & mesh generation — wavy channel geometry is parameterized by amplitude, wavelength, and phase; the script generates and meshes each variant automatically
Solver configuration — boundary conditions (inlet velocity, wall temperature, outlet pressure) are set programmatically per case
Solution & export — the solver runs to convergence and exports the resulting pressure, temperature, and velocity fields as structured data
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/FNO-2.png"
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/FNO-3.png"
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/FNO-4.png"
...
CFD Simulation: Ansys Fluent / PyFluent (automated data generation pipeline)
Neural Operators: Fourier Neural Operator (FNO), Physics-Informed Neural Operator (PINO)
Generative Modeling: Diffusion model for geometry generation
Frameworks: PyTorch, CUDA GPU computing
Target Application: Microchannel cooling in 2.5D SiP and 3D-IC advanced packaging
