...
Real-world supply chain networks are large, sparse, and partially observed — known edges (transactions) represent only a fraction of actual or potential supply relationships. The task is link prediction: given observed supplier-buyer relationships and node features (company attributes), predict which unobserved relationships are likely to exist.
